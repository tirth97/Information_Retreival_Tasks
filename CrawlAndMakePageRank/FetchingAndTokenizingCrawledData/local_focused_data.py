...
class LocalFocusedData:

    def __init__(self):
        self.links = []

    def fetch_focused_links(self):
        with open("./FOCUSED.txt", 'r') as file:
            data = file.read()
    ...
    def write_data_to_file(self, data, file_name):
        ...
        file_path = "./FocusedDataCrawl/WebsiteData/" + file_name + ".txt"
        try:
...
if __name__ == "__main__":
    bfs_data = LocalFocusedData()
    bfs_data.fetch_focused_links()
